...
public enum CosmeticDefinition {
    ...
    GOLD_GLOW(Kind.GLOW, Type.ENTITY_EFFECT, "Cosmetic_GoldGlow", "Gold", "#FFD700", 100),
    PURPLE_GLOW(Kind.GLOW, Type.ENTITY_EFFECT, "Cosmetic_PurpleGlow", "Purple", "#A855F7", 100),
    BLUE_GLOW(Kind.GLOW, Type.ENTITY_EFFECT, "Cosmetic_BlueGlow", "Blue", "#3B82F6", 100),
    GREEN_GLOW(Kind.GLOW, Type.ENTITY_EFFECT, "Cosmetic_GreenGlow", "Green", "#22C55E", 100),

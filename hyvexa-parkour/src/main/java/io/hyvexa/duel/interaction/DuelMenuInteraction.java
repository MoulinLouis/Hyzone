package io.hyvexa.duel.interaction;
...
public class DuelMenuInteraction extends SimpleInteraction {

    public static final BuilderCodec<DuelMenuInteraction> CODEC =
            BuilderCodec.builder(DuelMenuInteraction.class, DuelMenuInteraction::new).build();

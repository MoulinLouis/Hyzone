...
public class LeaderboardInteraction extends SimpleInteraction {
    private static final HytaleLogger LOGGER = HytaleLogger.forEnclosingClass();
    private static final String RUN_OR_FALL_PLUGIN_CLASS = "io.hyvexa.runorfall.HyvexaRunOrFallPlugin";
    private static final String RUN_OR_FALL_LEADERBOARD_PAGE_CLASS = "io.hyvexa.runorfall.ui.RunOrFallLeaderboardPage";

    public static final BuilderCodec<LeaderboardInteraction> CODEC =
            BuilderCodec.builder(LeaderboardInteraction.class, LeaderboardInteraction::new).build();
    ...
    public void handle(@Nonnull Ref<EntityStore> ref, boolean firstRun, float time,
        ...
        if (ModeGate.isRunOrFallWorld(world) && tryOpenRunOrFallLeaderboard(ref, store, player, playerRef)) {
            return;
        }
    ...
    private boolean tryOpenRunOrFallLeaderboard(Ref<EntityStore> ref,
        ...
        try {
            ...
            Class<?> pageClass = Class.forName(RUN_OR_FALL_LEADERBOARD_PAGE_CLASS);
            ...
            LOGGER.atWarning().withCause(e)
                    .log("Failed to open RunOrFall leaderboard page from WinterHoliday_Snowflake interaction.");
            return false;
        }
    }
}

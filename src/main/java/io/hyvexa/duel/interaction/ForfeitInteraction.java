...
public class ForfeitInteraction extends SimpleInteraction {

    public static final BuilderCodec<ForfeitInteraction> CODEC =
            BuilderCodec.builder(ForfeitInteraction.class, ForfeitInteraction::new).build();

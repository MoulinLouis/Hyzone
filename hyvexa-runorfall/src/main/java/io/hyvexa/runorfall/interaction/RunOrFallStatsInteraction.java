...
public class RunOrFallStatsInteraction extends SimpleInteraction {

    public static final BuilderCodec<RunOrFallStatsInteraction> CODEC =
            BuilderCodec.builder(RunOrFallStatsInteraction.class, RunOrFallStatsInteraction::new).build();

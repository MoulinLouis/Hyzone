...
public final class AscendOnboardingCopy {
    ...
    public static String ascensionThresholdDisplay() {
        return FormatUtils.formatBigNumber(AscendConstants.ASCENSION_VEXA_THRESHOLD);
    }
    ...
    public static final String HELP_SUBTITLE_FIRST_COMPLETION = "Vexa, multipliers, and buying runners";
    ...
    public static final String HELP_SUBTITLE_ELEVATION = "Spend vexa for a global multiplier";
    ...
    public static final String EXPLAINER_DESCRIPTION =
        "You've reached " + ascensionThresholdDisplay() + " vexa - Ascension is triggered automatically. "
        + "All progress (vexa, elevation, summit, runners) will be reset, but you'll earn 1 AP "

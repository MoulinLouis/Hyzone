...
public class AscendAscensionExplainerPage extends BaseAscendPage {
    ...
    public AscendAscensionExplainerPage(@Nonnull PlayerRef playerRef, AscendPlayerEventHandler eventHandler) {
    ...
    private void proceed() {
        ...
        if (eventHandler != null) {
            eventHandler.proceedWithAscensionCinematic(playerId);
        }
    }
}

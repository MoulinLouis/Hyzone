        ...
        if (BUTTON_RESET.equals(button)) {
            if (!pendingReset) {
                ...
                if (playerRef != null) {
                    ...
                    playerStore.save(playerId, new PurgePlayerStats(0, 0, 0));
                    scrapStore.resetPlayer(playerId);
                    weaponUpgradeStore.resetPlayer(playerId, weaponConfigManager.getDefaultWeaponIds());
